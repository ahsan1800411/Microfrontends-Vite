...
const remotesMap = {
'remote_app':{url:'http://localhost:5001/assets/remoteEntry.js',format:'esm',from:'vite'}
};
...
const __federation_var_remote_appstore = await __federation_method_getRemote("remote_app" , "./store");
 let useStore = __federation_method_unwrapDefault(__federation_var_remote_appstore); 
function App() {
  const [count, setCount] = useStore(0);
  return /* @__PURE__ */ jsxs("div", { className: "App", children: [
    /* @__PURE__ */ jsx("h1", { children: "Host Application" }),
    /* @__PURE__ */ jsx(Button, {}),
